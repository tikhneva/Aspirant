...
public:
    ...
    Student(string name, string surname, string father_name, string address, string phone_number) :Student("Minho", "Lee", "Lee Know", { 25, 10, 1998 }, "Seoul", "0325112014", { 1, 9, 2022 }) {}
...
int main()
{
    Aspirant aspirant("Minho", "Lee", "Lee Know", { 25, 10, 1998 }, "Seoul", "0325112014", { 1, 9, 2022 }, "Object-Oriented Programming");
    aspirant.Print();
